...
import sty from "./PlasmicButton.module.css"; // plasmic-import: SBcIalM9fJh/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: Etw_otJIc8D/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: ZBXIjvBejTc/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__f3Mrh)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__hhH2)}
                role={"img"}
              />
            ),
